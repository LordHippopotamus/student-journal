...
<div class="flex gap-1">
	...
	<input
		...
		class="p-1 border border-slate-950 bg-transparent dark:border-slate-50 rounded w-24 box-border"
	/>
	<select
		name="month"
		value={date.getMonth()}
		...
		class="p-1 border bg-transparent border-slate-950 dark:border-slate-50 rounded w-24 box-border h-[34px] block"
	>
