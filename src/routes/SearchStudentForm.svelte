...
<div class="my-8 p-8 shadow-lg rounded border-slate-950 border flex justify-center">
	<div class="flex flex-col gap-2">
		...
		<div class="flex flex-wrap gap-1">
			...
			<select
				name="group"
				bind:value={group}
				class="p-1 border bg-transparent border-slate-950 rounded text-base box-border h-[42px] block cursor-pointer"
			>
